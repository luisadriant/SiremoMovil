...
public class fragmentMeGusta extends Fragment implements OnTaskCompleted{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((Main)getActivity()).setupToolbar(R.id.toolbar, "Me Gustaron", R.color.colorPink, R.color.colorWhiteTrans, R.drawable.ic_burger);
    ...
    protected void consultaVestimentas() {
        try {
            String URL = Util.URL_SRV + "principal/meGustaron";
